...
import 'package:good_grab/presentation/login/login_controller.dart';
...
class LoginPage extends BaseView<LoginController> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Obx(() => Text(
                          controller.screenType == 'login' ? 'Log in'.tr : 'Sign up'.tr,
                  ...
                  Container(
                    ...
                    child: Obx(() => Text(
                          controller.screenType.value == 'login' ? 'login_title'.tr : 'signup_title'.tr,
  ...
  nameWidget() {
    return Obx(() => controller.screenType.value == 'login'
        ? Container()
        : Container(
            margin: const EdgeInsets.only(top: 20),
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration:
                        InputDecoration.collapsed(hintText: 'John Deo', hintStyle: mediumTextStyle(fontSize: dimen13, color: ColorsTheme.colHint)),
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                        ...
                        onChanged: (value) {
                          controller.checkEmailValid.value = false;
                          controller.changeButtonColor();
                          if(controller.isEmailValid(value.trim()) ){
                            EasyDebounce.debounce(
                                'my-debouncer', // <-- An ID for this particular debouncer
                                const Duration(milliseconds: 500), // <-- The debounce duration
                                    () => controller.isCheckNumberApi('email') // <-- The target method
                            );
                          }

                        },
                        decoration: InputDecoration.collapsed(
                            hintText: 'johndeo123@gmail.com', hintStyle: mediumTextStyle(fontSize: dimen13, color: ColorsTheme.colHint)),
                        style: mediumTextStyle(fontSize: dimen13, color: ColorsTheme.colBlack),
                      ),
                    ),
                    controller.screenType.value == "signup"
                        ? Obx(
                            () => controller.checkEmailValid.value == false
                                ? Visibility(
                                    visible: controller.emailAddressController.text.isNotEmpty,
                                    child: Container(
                ...
                Expanded(
                  child: TextField(
                    ...
                    onChanged: (value) {
                      ...
                      if (controller.screenType.value == "signup") {
                        controller.checkNumberValid.value = false;
                        EasyDebounce.debounce(
                            'my-debouncer', // <-- An ID for this particular debouncer
                            const Duration(milliseconds: 500), // <-- The debounce duration
                            () => controller.isCheckNumberApi('mobile') // <-- The target method
                            );
                      }
                    },
                    maxLength: 15,
                ...
                Obx(
                  () => controller.screenType.value == "signup"
                      ? Obx(
                          () => controller.checkNumberValid.value == false
                              ?  Visibility(
                                    visible: controller.numberController.value.text.isNotEmpty,
                                    child: Container(
                                      decoration: const BoxDecoration(
                                        shape: BoxShape.circle,
                                        color: Colors.red,
          ...
          : Align(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: const EdgeInsets.only(bottom: 20),
                    child: Lottie.asset(Res.errorFoundNewJson, width: 100, height: 100),
                  ),
                  Text(
                    "no_country_found".tr,
